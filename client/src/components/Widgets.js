...
const Widgets = () => {
  ...
  return (
    <div className='relative hidden ml-3 lg:flex flex-col items-center md:min-w-[350px] xl:w-[450px] py-1 space-y-5 '>
      <div className='sticky py-1.5 top-0 bg-black z-50 w-11/12 xl:w-10/12'>
        ...
        {showSearch && (
          ...
          >
            {loading && keyword.trim() && (
              <div className='px-4 py-2 animate-pulse flex items-center'>
            ...
            {!keyword.trim() && (
              <div className='text-center text-[#6e767d]'>
                Enter username or email
              </div>
            )}
            {!l && !loading && keyword.trim() && users.length === 0 && (
              <div className='text-center text-[#6e767d]'>No users found</div>
            )}
            {keyword &&
              users &&
